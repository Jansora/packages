 ...
 */
public interface DocumentConverter<DOCUMENT extends BaseDocument, ENTITY extends BaseEntityFactory> {
     ...
     * to document
     */
    List<DOCUMENT> toDocuments(List<? extends BaseEntityFactory> entities);
