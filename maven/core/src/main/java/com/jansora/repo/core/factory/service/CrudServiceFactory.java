...
import com.jansora.repo.core.factory.repository.BaseRepositoryFactory;
 ...
 * @since 1.0 <br>
 */
public interface CrudServiceFactory<RESPONSE extends BaseVo, REQUEST extends BaseReq> extends BaseRepositoryFactory {

    public abstract CrudRepositoryFactory<RESPONSE, REQUEST> factory();
