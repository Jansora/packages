...
import {
    ...
    InsertAction,
    UpdateAction
} from "../../../../components/request/action";
  ...
  return <React.Fragment>
    ...
    <Grid columns='equal'>
          ...
          <Form.Group widths='equal' >
            ...
            <Form.Field width={!!id ? 3 : 2}>
              ...
              <div style={{display: "flex", alignItems: "center"}}>
                <Button style={{marginRight: 20}} color={theme} content={!id ? '新建组件' : "更新组件"} onClick={() => save()} />
              </div>
            </Form.Field>
          </Form.Group>
        </Form>
      ...
      <Grid inverted>
        ...
        <Grid.Column width={9} style={{paddingRight: 0}} inverted>
          <Segment style={{padding: 0}}>
            <Label attached='top' color={theme}>预览</Label>
            <ActionRender template={raw} variable={variable} style={{height: 745}} />
