...
import {FetchAction} from "../../request/action";
  ...
  return <StyledPageLoading>
    <Button.Group>
      <Button
          ...
          color={pathname === `/codehub/action/${action.id}/demo` ? color : "black"}
      ...
      </Button>
      {
        loginStatus && responsive.middle && <Button
            style={{cursor: "pointer"}}
            color={pathname === `/codehub/action/${action.id}/edit` ? color : "black"}
